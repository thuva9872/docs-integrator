...
![Redis connector palette open with search field before any selection](/img/connectors/catalog/database/redis/redis_screenshot_01_palette.png)
...
![Redis connection form fully filled with all parameters before saving](/img/connectors/catalog/database/redis/redis_screenshot_02_connection_form.png)
...
![Redis Connections panel showing redisClient entry after saving](/img/connectors/catalog/database/redis/redis_screenshot_03_connections_list.png)
...
![Redis set operation configuration panel with all input fields populated](/img/connectors/catalog/database/redis/redis_screenshot_05_operation_filled.png)

![Completed canvas showing Automation Start connected to Redis set operation and End node](/img/connectors/catalog/database/redis/redis_screenshot_06_completed_flow.png)
