...
![Connector palette open showing search field and pre-built connector list](/img/connectors/catalog/database/snowflake/snowflake_screenshot_01_palette.png)
...
![Snowflake connection form with all parameters filled before saving](/img/connectors/catalog/database/snowflake/snowflake_screenshot_02_connection_form.png)
...
![Snowflake connection saved and visible in the Connections panel and canvas](/img/connectors/catalog/database/snowflake/snowflake_screenshot_03_connections_list.png)
...
![Snowflake Execute operation with SQL INSERT statement and all fields filled](/img/connectors/catalog/database/snowflake/snowflake_screenshot_05_operation_filled.png)
...
![Completed canvas flow showing Automation Start connected to Snowflake Execute node and End](/img/connectors/catalog/database/snowflake/snowflake_screenshot_06_completed_flow.png)
